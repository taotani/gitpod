...
type WorkspaceObjectExistsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceObjectExistsRequest) Reset() {
	*x = WorkspaceObjectExistsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceObjectExistsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceObjectExistsRequest) ProtoMessage() {}

func (x *WorkspaceObjectExistsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_workspace_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceObjectExistsRequest.ProtoReflect.Descriptor instead.
func (*WorkspaceObjectExistsRequest) Descriptor() ([]byte, []int) {
	return file_workspace_proto_rawDescGZIP(), []int{4}
}

func (x *WorkspaceObjectExistsRequest) GetOwnerId() string {
	if x != nil {
		return x.OwnerId
	}
	return ""
...
func (x *WorkspaceObjectExistsRequest) GetWorkspaceId() string {
	if x != nil {
		return x.WorkspaceId
	}
	return ""
...
func (x *WorkspaceObjectExistsRequest) GetObject() string {
	if x != nil {
		return x.Object
	}
	return ""
...
type WorkspaceObjectExistsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceObjectExistsResponse) Reset() {
	*x = WorkspaceObjectExistsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceObjectExistsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceObjectExistsResponse) ProtoMessage() {}

func (x *WorkspaceObjectExistsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_workspace_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceObjectExistsResponse.ProtoReflect.Descriptor instead.
func (*WorkspaceObjectExistsResponse) Descriptor() ([]byte, []int) {
	return file_workspace_proto_rawDescGZIP(), []int{5}
}

func (x *WorkspaceObjectExistsResponse) GetExists() bool {
	if x != nil {
		return x.Exists
	}
	return false
...
var file_workspace_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x74, 0x0a, 0x1c, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x4f, 0x62,
	...
	0x06, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x37, 0x0a, 0x1d, 0x57, 0x6f, 0x72, 0x6b, 0x73,
	0x70, 0x61, 0x63, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73,
	...
	0x32, 0xe5, 0x02, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x73, 0x0a, 0x14, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61,
	0x63, 0x65, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x55, 0x52, 0x4c, 0x12, 0x2b, 0x2e,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x57,
	0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64,
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x55, 0x52, 0x4c,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x64, 0x0a, 0x0f, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x26, 0x2e,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73,
	...
	0x12, 0x76, 0x0a, 0x15, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x4f, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x12, 0x2c, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	...
	0x63, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x52, 0x65,
...
var file_workspace_proto_goTypes = []interface{}{
	...
	(*WorkspaceObjectExistsRequest)(nil),  // 4: contentservice.WorkspaceObjectExistsRequest
	(*WorkspaceObjectExistsResponse)(nil), // 5: contentservice.WorkspaceObjectExistsResponse
}
var file_workspace_proto_depIdxs = []int32{
	...
	4, // 2: contentservice.WorkspaceService.WorkspaceObjectExists:input_type -> contentservice.WorkspaceObjectExistsRequest
	...
	5, // 5: contentservice.WorkspaceService.WorkspaceObjectExists:output_type -> contentservice.WorkspaceObjectExistsResponse
...
func file_workspace_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_workspace_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceObjectExistsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_workspace_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceObjectExistsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
