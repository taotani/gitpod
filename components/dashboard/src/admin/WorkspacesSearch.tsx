...
export function WorkspaceSearch(props: Props) {
    ...
    const search = async () => {
        setSearching(true);
        try {
            let searchTerm: string | undefined = searchQuery;
        ...
        <div className="pt-8 flex">
            <div className="flex justify-between w-full">
                <div className="flex">
                    ...
                    <input type="search" placeholder="Search Workspaces" onKeyDown={(ke) => ke.key === 'Enter' && search() } onChange={(v) => { setSearchQuery(v.target.value) }} />
                </div>
